...
@section('content')
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <h5 class="card-header fw-bold"><i class="fa fa-sort-amount-down"></i> {{ $title }}</h5>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-2">
                            <a style="border-radius: 50px" href="{{ route('kas.create', ['jenis' => 'pengeluaran']) }}" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Tambah</a>
                        </div>
                        <div class="col-md-10">
