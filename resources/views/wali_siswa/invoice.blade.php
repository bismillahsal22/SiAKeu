		...
		<div class="invoice-box">
			<table cellpadding="0" cellspacing="0">
						...
						<table>
							<tr>
								<td>
									...
									NIS/Nama : {{ $tagihan->siswa->nis }}/{{ $tagihan->siswa->nama }}<br />
				...
				<tr class="heading">
					...
					<td style="text-align: start">Nama Tagihan</td>
					<td style="text-align: end ">Jumlah</td>
				</tr>
                @foreach ($tagihan->detailTagihan as $item)
                    <tr class="item">
                        <td width="1%" style="text-align: center">{{ $loop->iteration }}</td>
                        <td style="text-align: start">{{ $item->nama_bayar }}</td>
                ...
                <tr>
                    <td colspan="3">
                        <div>
                            Terbilang : <i>{{ ucwords(terbilang($tagihan->detailTagihan->sum('jumlah_bayar'))) }} Rupiah</i>
                        </div>    
                    </td>
                </tr>
                <tr style="text-align: end; margin-top:5%">
                    <td colspan="3">
