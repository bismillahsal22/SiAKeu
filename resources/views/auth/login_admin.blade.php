    ...
    <div class="container d-flex justify-content-center align-items-center min-vh-100">
        <div class="row border rounded-5 p-3 bg-white shadow box-area">
            <div class="col-md-6 rounded-5 d-flex justify-content-center align-items-center flex-column left-box" style="background: #109490;">
                <h2 class="text-white text-center" style="font-weight: 600;">Selamat Datang<br>Admin SiAKeu</h2>
            ...
            <div class="col-md-6 right-box">
                <div class="row align-items-center">
                    ...
                    <h3 class="text-center mb-4" style="font-weight: bold;">Login<br>Administrator</h3>
                    ...
                    <form method="POST" action="{{ route('postloginadmin') }}">
                        ...
                        <div class="input-group mb-5 d-flex justify-content-between">
                            <div class="form-check">
                                ...
                                <label for="remember-me" class="form-check-label text-secondary"><small>Ingatkan Saya</small></label>
                            </div>
                            <div class="forgot">
                        ...
                        <div class="row">
                            <small class="text-center">Sudah memiliki Akun?<a href="{{ route('register') }}">Daftar Akun</a></small>
                        </div>
                    </form>
                </div>
            </div>
