    ...
    <div class="container d-flex justify-content-center align-items-center min-vh-100">
        <div class="row border rounded-5 p-3 bg-white shadow box-area">
            <div class="col-md-6 rounded-5 d-flex justify-content-center align-items-center flex-column left-box" style="background: #109490;">
                <h3 class="text-white text-center" style="font-weight: 600;">Sistem Administrasi Keuangan <br>SMA Negeri 1 Seyegan</h3>
            ...
            <div class="col-md-6 right-box">
                <div class="row align-items-center">
                    ...
                    <h3 class="text-center mb-4" style="font-weight: bold;">Daftar Akun <br>Administrator</h3>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-3">
                            <button class="btn btn-lg btn-primary w-100 fs-6"><a href="{{ route('login.admin') }}"></a>Daftar Akun</button>
                        </div>
                        <div class="row">
                            <small class="text-center">Sudah memiliki Akun?<a href="{{ route('login.admin') }}"> Login</a></small>
                        </div>
                    </form>
                </div>
            </div>
